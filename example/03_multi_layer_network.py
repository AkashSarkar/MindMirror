...
def demonstrate_multi_layer_network():
    ...
    for i in range(5):
        ...
        print(f"   Point ({point[0]:.2f}, {point[1]:.2f}), distance={distance:.2f}, label={label}")
    print()
    ...
    for point, expected in test_points:
        ...
        print(f"   Point {point}: predicted {prediction.data:.3f} → {predicted_class}, expected {expected} {'✓' if is_correct else '✗'}")
